    ...
    children: [
                {
                  ...
                  children: [
                                ...
                                {
                                  path: 'criar', // Rota padrão do home
                                    loadComponent:() => import('./pages/home-pages/HomePages/home-body/HomeBodyComponents/home-criar/home-criar.component').then(m => m.HomeCriarComponent)
                                }
                            ],
                },
    ]},
